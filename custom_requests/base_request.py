...
class ZapRequests:
    def __init__(self, config: Any, **kwargs):
        ...
        self.parsed_api_url = None
        self.session = curl_cffi.Session()
        self.user_id = None

    def set_parsed_api_url(self, parsed_api_url: str) -> None:
        self.parsed_api_url = URLParser(parsed_api_url)
    ...
    def get_all(self) -> list[Listing]:
        ...
        while page_number <= ceil(total_results / results_per_page):
            ...
            try:
                ...
                logger.error(e)
                logger.info(f"URL: {self.get_paginated_url(results_per_page, page_number)}")
    ...
    def get_user_id_from_cookies(self):
        headers = {
            ...
            'Referer': f'https://www.zapimoveis.com.br/',
            'x-domain': f'.zapimoveis.com.br',
            'X-DeviceId': '93f2af3c-7628-4222-a145-2ca174305347',
            'Origin': f'https://www.zapimoveis.com.br',
